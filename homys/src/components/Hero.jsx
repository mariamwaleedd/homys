  ...
  return (
    <section className="hero-section">
      <div className="hero-bg" style={{ backgroundImage: `url(${heroImg})` }}>
        ...
        <div className="list-property-btn">
        ...
        <div className="booking-bar">
          ...
          <div className="booking-item">
            <div className="item-label">
              <svg className="white-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
              <h3>Location</h3>
            </div>
